...
spark = SparkSession.builder.appName("City Wind Data Preprocessing ").getOrCreate()
...
for city in city_df.collect():      
    ...
    wind_df.coalesce(1).write.csv(f'file:///home/hadoop/Documents/newdata/temp/{city["City"]}_wind', header=True, mode="ignore")
