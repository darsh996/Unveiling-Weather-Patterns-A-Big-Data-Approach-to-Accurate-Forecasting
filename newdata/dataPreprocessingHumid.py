...
spark = SparkSession.builder.appName("City Humid Data Preprocessing ") \
.getOrCreate()
...
for city in city_df.collect():
    #print(city["City"])
    # Load the json file
    file_path = f'file:///home/hadoop/Documents/newdata/humid/{city["City"]}_{city["latitude"]}_{city["longitude"]}_*.json'
    ...
    humid_df.coalesce(1).write.csv(f'file:///home/hadoop/Documents/newdata/temp/{city["City"]}_humid', header=True, mode="ignore")
